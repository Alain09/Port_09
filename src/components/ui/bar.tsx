...
function Bar({ texte, time, percent }: { texte: string, time: number, percent: number }) {
    ...
    return (
        <div className='flex flex-col h-fit w-full gap-1 '>
            ...
            <div className='flex justify-center items-center  h-[60px] w-full px-5 py-3 bg-third/5 dark:bg-[#d3d3d3]/40 rounded-md  '>
                <div className='relative flex justify-center items-center w-full  '>
                    <div className=' absolute left-0 h-[20px] w-full z-10 rounded-full bg-third/60 dark:bg-second/10'>
                    ...
                    <motion.div
                        ...
                        className=' absolute left-0 h-[20px]  z-20 bg-primar rounded-full' >
